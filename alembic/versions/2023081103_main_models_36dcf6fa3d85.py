...
Revision ID: 36dcf6fa3d85
Revises: 0e972bb26cf0
Create Date: 2023-08-11 10:03:16.638029
...
revision = "36dcf6fa3d85"
down_revision = "0e972bb26cf0"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("type", sa.String(length=254), nullable=False),
        sa.Column("quiz_id", sa.UUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ["quiz_id"],
            ["quizzes.id"],
